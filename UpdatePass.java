...
public class UpdatePass extends Frame implements ActionListener, WindowListener{
			...
			if(isEmpty(t) || isEmpty(t3)){
				...
				if(checkAuth()){
					if(t3.getText().length()>=0){
						DataAccess da=new DataAccess();
						try{
							String sql="update customer set password='"+t3.getText()+"' where password='"+t.getText()+"'";
							...
							JOptionPane.showMessageDialog(this,"Exeption In Pasword Update!");
						}
					}
					else{
						JOptionPane.showMessageDialog(this,"Password length should be atleast 6");
					}
				}
				else{
					JOptionPane.showMessageDialog(this,"Error!");
