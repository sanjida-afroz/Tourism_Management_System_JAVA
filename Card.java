...
public class Card extends Frame implements ActionListener, WindowListener{
	private TextField c_id,port,cardnum,Tamount,pay,pass;
	...
	public Card(){
		...
		g=new ButtonGroup();
		add(l);add(c_id);add(cardnum);add(l4);
		...
		cardnum.setBounds(135,95,207,30);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Pay")){
			if(isEmpty(c_id) || isEmpty(cardnum) || isEmpty(port) || isEmpty(Tamount) || isEmpty(pay)){
