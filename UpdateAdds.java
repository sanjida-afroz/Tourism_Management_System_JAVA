...
public class UpdateAdds extends Frame implements ActionListener, WindowListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Change")){
			if(isEmpty(t) || isEmpty(t3)){
				...
				DataAccess da=new DataAccess();
				try{
					String sql="update customer set address='"+t.getText()+"' where password='"+t3.getText()+"'";
