...
public class DeleteTourPackage extends Frame implements ActionListener, WindowListener{
	private JButton b,b2;
	private TextField t;
	private JLabel l;
	private Frame parent;
	public DeleteTourPackage(){
		super("Delete Tour Package");
		...
		b.setBounds(140,110,95,30);
		b2.setBounds(245,110,95,30);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Delete")){
			if(isEmpty(t)){
				...
				try{
					String sql="DELETE FROM tour_package WHERE tour_package.package_id = '"+t.getText()+"'";
