...
public class UpdateEmail extends Frame implements ActionListener, WindowListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Change")){
			if(isEmpty(t) || isEmpty(t3)){
			...
			else if(!isValidEmail(t.getText())){
				...
				if(checkAuth()){
					DataAccess da=new DataAccess();
					try{
						String sql="update customer set email='"+t.getText()+"' where password='"+t3.getText()+"'";
						...
						JOptionPane.showMessageDialog(this,"Exception in Email Update");
					}
				}
				else{
					JOptionPane.showMessageDialog(this,"Error!");
