...
public class SelTicket extends Frame implements ActionListener, WindowListener{
	private JButton b,b2;
	private TextField t,t2,t3;
	private JLabel l,l3,l2;
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Ok")){
			if(isEmpty(t) || isEmpty(t3)){
				...
				DataAccess da=new DataAccess();
				try{
					String sql="insert into booking(c_id,ticket_id) values('"+t.getText()+"','"+t3.getText()+"')";
