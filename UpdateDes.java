...
public class UpdateDes extends Frame implements ActionListener, WindowListener{
	...
	public UpdateDes(){
		...
		t2.setBounds(140,110,200,100);
		b.setBounds(140,240,90,30);
	...
	public void actionPerformed(ActionEvent e){
		...
		if(sig.equals("Update")){
			if(isEmpty(t)){
				...
				try{
					String sql="UPDATE tour_package SET package_des = '"+t2.getText()+"' WHERE package_id = '"+t.getText()+"'";
